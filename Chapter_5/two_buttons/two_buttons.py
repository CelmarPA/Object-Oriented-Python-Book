...
barkSound: pygame.mixer.Sound = pygame.mixer.Sound('bark.wav')
meowSound: pygame.mixer.Sound = pygame.mixer.Sound('meow.wav')

# 5 - Initialize variables
# Create instances of a Simple button
buttonA: pygwidgets.TextButton = pygwidgets.TextButton(window, (20, 30), 'Bark')
buttonB: pygwidgets.TextButton = pygwidgets.TextButton(window, (150, 30), 'Meow')
