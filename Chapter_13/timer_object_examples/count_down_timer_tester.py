...
o_header_message: pygwidgets.DisplayText = pygwidgets.DisplayText(window, (0, 50),
                                                                  f"Click Start to start a {TIMER_LENGTH}-second timer:",
...
o_timer: CountDownTimer = CountDownTimer(TIMER_LENGTH)  # create a timer object
...
while True:
    ...
    if o_timer.ended():     # True here means timer has ended
        o_start_button.enable()
        o_timer_message.hide()
        print("Timer ended")
