...
FRAMES_PER_SECOND: int = 30     # takes 1/30th of a second for each frame
...
n_frames_elapsed: int = 0
n_frames_to_wait: int = 0
...
while True:
    ...
    for event in pygame.event.get():
        ...
        if start_button.handleEvent(event):
            n_frames_elapsed = 0   # initialize a counter
    ...
    if timer_running:
        n_frames_elapsed += 1   # increment the counter
